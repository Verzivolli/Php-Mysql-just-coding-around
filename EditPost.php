...
if (isset($_POST["Submit"])) {
    ...
    if (empty($Title)) {
        ...
        $Query = "UPDATE {$TableName} SET datetime='$DateTime' title='$Title' category='$Category'
                image='$Image' author='$Admin' post='$Post
                    WHERE id='{$gotid}'";
        ...
        <div class="col-sm-10">
            ...
            <div>
                ...
                if (isset($_GET["edit"])) {
                    ...
                    $ViewQuery = "SELECT * FROM {$TableName} WHERE id='{$PostIDFromURL}'";
                } else{
                    $_SESSION["ErrorMessage"] = "Something went wrong";
                ...
                <form action="EditPost.php?edit=<?php echo $id ?>" method="post" enctype="multipart/form-data" >
                    <fieldset>
                            <div class="form-group">
                                ...
                                <input value="<?php echo $Title; ?>" class="form-control" type="text" name="<?php echo $Title; ?>" id="title" placeholder="Title" />
                            </div>
                            <div class="form-group">
                                <label for="categoryselect"><span class="field-info">Existing category:<?php echo $Categoryu; ?></span></label>
                            ...
                            <div class="form-group">
                                ...
                                <textarea value="<?php echo $Post; ?>" class="form-control" id="postarea" name="Post"><?php echo $Post; ?></textarea>
                            </div>
                            <div class="form-group">
