...
if (isset($_POST['id'])) {
    ...
    if ($link->query($deletequery) === TRUE) {
        $_SESSION["SuccessMessage"] = "Post successfuly deleted from database.";
...
<head>
	...
	<script src="https://cdnjs.cloudflar e.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
...
<div class="navbar navbar-inverse" role="navigation">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="collapse">
            ...
            <form action="blog.php" class="navbar-form navbar-right" method="GET"><!-- if action="Fullpost.php can see multiple full posts" -->
        ...
        <div class="col-sm-8">
            ...
            <div class="blogpost thumbnail">
                ...
                <form action="DeletePost.php?id=<?php echo $id; ?>" method="post">
                    ...
                    <button class="btn btn-sm btn-danger pull-right" value="submit" type="submit">Delete!!!</button>
                </form>
            </div>
            <?php }} ?>
        </div><!-- end of main -->
